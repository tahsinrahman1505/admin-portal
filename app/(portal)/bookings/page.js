  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[440px] max-w-[92vw] bg-[var(--surface-raised)] border border-white/[0.08] rounded-2xl z-50 overflow-hidden"
      >
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed right-0 top-0 h-full w-[360px] bg-[var(--surface-raised)] border-l border-white/[0.08] z-50 flex flex-col"
      >
