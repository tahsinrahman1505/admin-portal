  ...
  return (
    <>
      ...
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }}
        className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[480px] glass-overlay sheen border border-white/[0.09] rounded-2xl z-50 p-6 shadow-2xl">
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed right-0 top-0 h-full w-[560px] glass-overlay sheen border-l border-white/[0.08] z-50 flex flex-col overflow-hidden"
      >
        {/* Header */}
