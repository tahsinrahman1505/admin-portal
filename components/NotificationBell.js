...
export default function NotificationBell({ clientId }) {
  ...
  return (
    <div className="relative" ref={dropRef}>
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute left-0 top-10 w-80 rounded-2xl border border-white/[0.08] bg-[var(--surface-overlay)] shadow-[0_16px_48px_rgba(0,0,0,0.6)] z-50 overflow-hidden">
          {/* Header */}
